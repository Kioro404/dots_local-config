...
import qs.modules.panel.ii.sidebar.right.quickToggles.androidStyle
...
AbstractQuickPanel {
    ...
    readonly property int columns: Config.options.sidebar.right.quickToggles.columns
    readonly property list<var> toggles: Config.ready ? Config.options.sidebar.right.quickToggles.toggles : []
