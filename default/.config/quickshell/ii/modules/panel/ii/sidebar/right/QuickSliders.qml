...
Rectangle {
    ...
    Column {
        ...
        Loader {
            ...
            visible: active
            active: Config.options.sidebar.right.quickSliders.showBrightness
        ...
        Loader {
            ...
            visible: active
            active: Config.options.sidebar.right.quickSliders.showVolume
            sourceComponent: QuickSlider {
        ...
        Loader {
            ...
            visible: active
            active: Config.options.sidebar.right.quickSliders.showMic
            sourceComponent: QuickSlider {
                materialSymbol: "mic"
