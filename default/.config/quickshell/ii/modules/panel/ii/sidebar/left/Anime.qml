...
import qs.modules.panel.ii.sidebar.left.anime
import QtQuick
...
Item {
    ...
    function handleInput(inputText) {
        if (inputText.startsWith(root.commandPrefix)) {
            ...
            Booru.makeRequest(tagList, Persistent.states.booru.allowNsfw, Config.options.sidebar.left.booru.limit, pageIndex);
        }
    }
