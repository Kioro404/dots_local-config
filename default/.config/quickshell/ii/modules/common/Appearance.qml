...
Singleton {
    ...
    sizes: QtObject {
        ...
        property real barHeight: Config.options.panel.tools[Config.panelFamilyIndexII].bar.config.cornerStyle === 1 ? 
            (baseBarHeight + root.sizes.hyprlandGapsOut * 2) : baseBarHeight
        property real barCenterSideModuleWidth: Config.options.panel.tools[Config.panelFamilyIndexII].bar.config.verbose ? 360 : 140
        ...
        property real verticalBarWidth: Config.options.panel.tools[Config.panelFamilyIndexII].bar.config.cornerStyle === 1 ? 
