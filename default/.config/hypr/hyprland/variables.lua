...
fileManager = [[~/.config/hypr/hyprland/scripts/launch_first_available.sh 'dolphin' 'nautilus' 'nemo' 'thunar' "$terminal yazi"]]
...
codeEditor = [[~/.config/hypr/hyprland/scripts/launch_first_available.sh 'windsurf' 'antigravity' 'code' 'codium' 'cursor' 'zed' 'zedit' 'zeditor' 'kate' 'gnome-text-editor' 'emacs' "command -v nvim && $terminal nvim" "command -v micro && $terminal micro"]]
...
taskManager = [[~/.config/hypr/hyprland/scripts/launch_first_available.sh 'gnome-system-monitor' 'plasma-systemmonitor --page-name Processes' "command -v btop && $terminal btop"]]
